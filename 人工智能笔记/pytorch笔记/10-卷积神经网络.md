...
如果需要得到$m$通道的输出，则要准备$m$份的卷积阵。此时对应的权值是 $m*n*k_{width}*k_{height}$的四维量。
...
论文：[Identity Mappings in Deep Residual Networks.](https://link.springer.com/chapter/10.1007/978-3-319-46493-0_38)
