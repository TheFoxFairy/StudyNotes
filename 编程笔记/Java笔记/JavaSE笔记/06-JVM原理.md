...
![](../../../../../../../Pictures/assets/06-JVM原理/202205170907407-1652754602214.png)
...
![image-20200704112700211](../../../../../../../Pictures/assets/06-JVM原理/202205170907184-1652754615640.png)
...
![image-20200704183048061](../../../../../../../Pictures/assets/06-JVM原理/202205170907914-1652754630433.png)

Java的体系结构

![image-20200704183236169](../../../../../../../Pictures/assets/06-JVM原理/202205170907826-1652754639553.png)
...
![image-20200704183436495](../../../../../../../Pictures/assets/06-JVM原理/202205170907953-1652754647203.png)

**执行引擎包含三部分：解释器，及时编译器，垃圾回收器。**

#### Java代码执行流程

![image-20200704210429535](../../../../../../../Pictures/assets/06-JVM原理/202205170907496-1652754657427.png)
...
![img](../../../../../../../Pictures/assets/06-JVM原理/202205170907458-1652754693492.png)
...
![image-20200705082255746](../../../../../../../Pictures/assets/06-JVM原理/202205170907016-1652754701768.png)

完整的流程图如下所示：

![image-20200705082601441](../../../../../../../Pictures/assets/06-JVM原理/202205170907409-1652754710667.png)
...
![image-20200705094149223](../../../../../../../Pictures/assets/06-JVM原理/202205170908426-1652754720790.png)
...
![image-20200705103636003](../../../../../../../Pictures/assets/06-JVM原理/202205170908937-1652754731477.png)
...
![image-20200705111843003](../../../../../../../Pictures/assets/06-JVM原理/42eab7a6999400aaf897cf0767471adb.png)

比如大厨做饭，我们把大厨后面的东西（切好的菜，刀，调料），比作是**运行时数据区**。而厨师可以类比于**执行引擎**，将通过准备的东西制作成精美的菜品。

![image-20200705112036630](../../../../../../../Pictures/assets/06-JVM原理/b563b0aba573cc74d7b1e95be328c713.png)
...
![image-20200705112416101](../../../../../../../Pictures/assets/06-JVM原理/202205171005220.png)

说明：方法区在JVM规范中是一个逻辑概念，由虚拟机自己进行具体实现，**jdk7和以前的版本使用的是堆上的永久代实现的方法区**，而在**jdk8及以后使用的是元数据区实现方法区**。

##### 线程的内存空间

![image-20200705112601211](../../../../../../../Pictures/assets/06-JVM原理/d7feec9f24e4484cba1c4bba2a390079)
...
![image-20200705155551919](../../../../../../../Pictures/assets/06-JVM原理/fde813264c9149c2bec1aa49a242ea1c)
...
![image-20200705155728557](../../../../../../../Pictures/assets/06-JVM原理/5abce408e6f747b8a454c490177ae925)
...
![image-20220506121452041](../../../../../../../Pictures/assets/06-JVM原理/image-20220506121452041.png)

通过PC寄存器，我们就可以知道当前程序执行到哪一步了

![image-20200705161007423](../../../../../../../Pictures/assets/06-JVM原理/4d74323dff6d4af5b7f99e3ad104443c)
...
![image-20200705161812542](../../../../../../../Pictures/assets/06-JVM原理/c83736fe23d34dc698a4ae54c1b576e7)
...
![image-20200705161849557](../../../../../../../Pictures/assets/06-JVM原理/3c129e20773940808610fa78d82e9f11)
...
![image-20200705163928652](../../../../../../../Pictures/assets/06-JVM原理/5c44a07526284bab89afa2cd5359f49d)
...
![image-20200705164722033](../../../../../../../Pictures/assets/06-JVM原理/7eace01cbd504c349f3a476e3c82391a)
...
![image-20200705203142545](../../../../../../../Pictures/assets/06-JVM原理/2c84aa8259b646cdbf67d34de1e4d527)
...
![image-20200705204836977](../../../../../../../Pictures/assets/06-JVM原理/ee9758bc10e749a18aacf4ee10650a5d)
...
![image-20200705212454445](../../../../../../../Pictures/assets/06-JVM原理/941942a2fc56429182ce18d4e07909d7)

##### Slot的重复利用

栈帧中的局部变量表中的槽位是可以重用的，如果一个局部变量过了其作用域，那么在其作用域之后申明的新的局部变就很有可能会复用过期局部变量的槽位，从而达到节省资源的目的。

![image-20200705213106749](../../../../../../../Pictures/assets/06-JVM原理/b9b09864a1eb4707b4eb6b4639e108ab)
...
![image-20200706090618332](../../../../../../../Pictures/assets/06-JVM原理/e9686990052040fd92ef809f1f35dc87)

代码举例

![image-20200706090833697](../../../../../../../Pictures/assets/06-JVM原理/38f31bb9b2c845bb9bc01121d04a2a3d)
...
![image-20200706093131621](../../../../../../../Pictures/assets/06-JVM原理/3cd060c0cb4045b480419ff9fb1650cc)

执行完后，让PC + 1，指向下一行代码，下一行代码就是将操作数栈的元素存储到局部变量表1的位置，我们可以看到局部变量表的已经增加了一个元素。

![image-20200706093251302](../../../../../../../Pictures/assets/06-JVM原理/cd55b378914848bcb7dd4ca48d3ee64c)
...
![image-20200706093646406](../../../../../../../Pictures/assets/06-JVM原理/ef8b435d3e0b4eebb0cfc7b785fa41c5)

![image-20200706093751711](../../../../../../../Pictures/assets/06-JVM原理/7067465111ef4d23837cbf6b78fd7757)

然后从局部变量表中，依次将数据放在操作数栈中。

![image-20200706093859191](../../../../../../../Pictures/assets/06-JVM原理/06c7dd9ebefe4f4196536a6bc70bcf37)

![image-20200706093921573](../../../../../../../Pictures/assets/06-JVM原理/e8273b43143a4b6e85f609ec127e37c3)

然后将操作数栈中的两个元素执行相加操作，并存储在局部变量表3的位置。

![image-20200706094046782](../../../../../../../Pictures/assets/06-JVM原理/4b925d70cd4a421b84ad9442688f7781)

![image-20200706094109629](../../../../../../../Pictures/assets/06-JVM原理/abbd65b4735e41de94de91c15f43211e)
...
![](../../../../../../../Pictures/assets/06-JVM原理/922e70c5bff0f7032c5d9bfc856c9af5.png)
...
![image-20200706101251847](../../../../../../../Pictures/assets/06-JVM原理/a1ad1eb6cdea4cc08e79a149cf81463e)
...
![image-20200706144954070](../../../../../../../Pictures/assets/06-JVM原理/4b70ab8cfeb04992b54ffd0481e41b28)
...
![image-20201122100707313](../../../../../../../Pictures/assets/06-JVM原理/20742d9c3f16ca6fdca20f3436d0d2dd.png)
...
![image-20201126161748829](../../../../../../../Pictures/assets/06-JVM原理/7d4cb7d862a17bcc86a568f0d69de215.png)
...
![image-20200706174708418](../../../../../../../Pictures/assets/06-JVM原理/526c3949bafe44a0815dc208f8540a0b)
...
![image-20200706195127740](../../../../../../../Pictures/assets/06-JVM原理/bc6bf35762524d70842612fb31cf2821)
...
![image-20200706201904057](../../../../../../../Pictures/assets/06-JVM原理/59135bd85a09d55fe52cfffcd683bb6c.png)
...
![image-20220508110800908](../../../../../../../Pictures/assets/06-JVM原理/image-20220508110800908.png)

##### 查看堆内存

打开`Java\jdk1.8.0_202\bin\jvisualvm.exe`，安装`GC` 插件(工具>插件)

![image-20220508111021601](../../../../../../../Pictures/assets/06-JVM原理/image-20220508111021601.png)
...
![第08章_堆空间-java7](../../../../../../../Pictures/assets/06-JVM原理/706f386313d9ea91d0468fa3bc927ceb.png)
...
![第08章_堆空间-java8](../../../../../../../Pictures/assets/06-JVM原理/b7bec51b59d44dbc2752858cb1285e23.png)
...
![image-20220508113916669](../../../../../../../Pictures/assets/06-JVM原理/image-20220508113916669.png)
...
![image-20200728224943553](../../../../../../../Pictures/assets/06-JVM原理/a143c24ad83ef70d18ecccf9826479c4.gif)
...
![image-20200707075847954](../../../../../../../Pictures/assets/06-JVM原理/0cab12cc6c6b4161bb6943641bf5a415)

下面这参数开发中一般不会调：

![image-20200707080154039](../../../../../../../Pictures/assets/06-JVM原理/d1fae1d005f148b8be0725e5aec2d44e)
...
![image-20200707084208115](../../../../../../../Pictures/assets/06-JVM原理/8624676b62fd42febd972c18ea0f495e)
...
![image-20200707084714886](../../../../../../../Pictures/assets/06-JVM原理/a04eaf5aed6f434e9928fc3f8bfad78b)
...
![image-20200707085232646](../../../../../../../Pictures/assets/06-JVM原理/40550985eacc4816a9302aa8715a786d)

我们继续不断的进行对象生成 和 垃圾回收，当Survivor中的对象的年龄达到15的时候，将会触发一次 Promotion晋升的操作，也就是将年轻代中的对象晋升到老年代中。

![image-20200707085737207](../../../../../../../Pictures/assets/06-JVM原理/c91690501f594fb0a004836a4e9f1fd3)
...
![image-20200707091058346](../../../../../../../Pictures/assets/06-JVM原理/6804a8a5490e4636a3fb0444a7cbe685)
...
![垃圾回收](../../../../../../../Pictures/assets/06-JVM原理/5e792bae44084551823b4fdae3ff9cfd)
...
![image-20200707095606813](../../../../../../../Pictures/assets/06-JVM原理/98f49e516b2d4bf5b301c2ba345586a4)
...
![image-20200707101511025](../../../../../../../Pictures/assets/06-JVM原理/7d6678d7d3494a698a7d8323f97457a9)
...
![image-20200707101543871](../../../../../../../Pictures/assets/06-JVM原理/73e41a92ae1945fa81c9c62da1292f41)
...
![image-20200707103547712](../../../../../../../Pictures/assets/06-JVM原理/219e38c94edb4f009df3f02dc1c97e7e)
...
![image-20200707104253530](../../../../../../../Pictures/assets/06-JVM原理/9dbaa2a7756b496e99a264b0cbb8b29b)
...
![image-20220510135240244](../../../../../../../Pictures/assets/06-JVM原理/image-20220510135240244.png)
...
![image-20220510135354041](../../../../../../../Pictures/assets/06-JVM原理/image-20220510135354041.png)
...
![image-20200707205634266](../../../../../../../Pictures/assets/06-JVM原理/e4e6cd5af92744a48d4300677810414c)
...
![image-20200708093918121](../../../../../../../Pictures/assets/06-JVM原理/d7f8b4fdf34b4766a7b6808ac403fde3)

##### 从线程共享与否的角度看

![image-20200708094507624](../../../../../../../Pictures/assets/06-JVM原理/37892597a5b94a9ca662c29e6cb2cc3f)

ThreadLocal：如何保证多个线程在并发环境下的安全性？典型应用就是数据库连接管理，以及会话管理。

##### 三者的关系

![image-20200708094747667](../../../../../../../Pictures/assets/06-JVM原理/07bb6009ddd04a71846d5f91899b9f5c)
...
![image-20200708095853544](../../../../../../../Pictures/assets/06-JVM原理/552f2083dbaa4f309e92480765c83f82)
...
![image-20200708102919149](../../../../../../../Pictures/assets/06-JVM原理/4b3b02b7f561487e8bbcb8e6498d3443)

而到了JDK8，终于完全废弃了永久代的概念，改用与JRockit、J9一样在本地内存中实现的元空间（Metaspace）来代替。

![image-20200708103055914](../../../../../../../Pictures/assets/06-JVM原理/4e79dda200da4486bb7f0b074df0c964)
...
![image-20200708111756800](../../../../../../../Pictures/assets/06-JVM原理/c6bec242cf9d428b852a2d48b5a31674)
...
![image-20200708161728320](../../../../../../../Pictures/assets/06-JVM原理/dd620cafe1fb48cb9dce96c21dde8e50)

《深入理解Java虚拟机》书中对方法区（Method Area）存储内容描述如下：**它用于存储已被虚拟机加载的类型信息、常量、静态变量、即时编译器编译后的代码缓存等**。

![image-20200708161856504](../../../../../../../Pictures/assets/06-JVM原理/c6ff78af16704ef09849a605ba81a99c)
...
![image-20200708171151384](../../../../../../../Pictures/assets/06-JVM原理/64cc63af44664309a65119d50990a0bb)
...
![image-20200708172357052](../../../../../../../Pictures/assets/06-JVM原理/646e709a17834b6aa094be117a84f155)
...
![image-20200708204750374](../../../../../../../Pictures/assets/06-JVM原理/b9a99a2500fa49f889da87f7fdc4c874)

首先现将操作数500放入到操作数栈中

![image-20200708204953552](../../../../../../../Pictures/assets/06-JVM原理/242afce1af1f4817a12119b94258dabf)

然后存储到局部变量表中

![image-20200708205029376](../../../../../../../Pictures/assets/06-JVM原理/dbe28e9e923a4ed4b3b845ababa23bc6)

然后重复一次，把100放入局部变量表中，最后再将变量表中的500 和 100 取出，进行操作

![image-20200708205221737](../../../../../../../Pictures/assets/06-JVM原理/961564f3f23b473c8f4b71586d0c6831)
...
![image-20200708215025527](../../../../../../../Pictures/assets/06-JVM原理/53073221f4e042afb284a4ddb8abc0c6)
...
![image-20200709151033237](../../../../../../../Pictures/assets/06-JVM原理/e26853a3935f472eafd07c68e1c217a0)
...
![image-20200709152801713](../../../../../../../Pictures/assets/06-JVM原理/d5b6883b11e140f3b8617814e75667aa)

#### 对象的访问定位

##### JVM是如何通过栈帧中的对象引用访问到其内部的对象实例呢？

![image-20200709164149920](../../../../../../../Pictures/assets/06-JVM原理/76e966d3338c43b3920eb9dbad8220b8)

![第10章_对象访问定位](../../../../../../../Pictures/assets/06-JVM原理/c62ff2fccdd6dd52d6b39e56277421a7.png)
...
![image-20200709170907611](../../../../../../../Pictures/assets/06-JVM原理/a171a5aa08054d17a3e016fcae5cac7e.png)
...
![image-20200709230647277](../../../../../../../Pictures/assets/06-JVM原理/3a47858459724743a272c6a2d5e4c9b5.png)
...
![image-20200710080707873](../../../../../../../Pictures/assets/06-JVM原理/bb492efe1e4245469a1779f1af6670ed.png)
...
![Untitled](../../../../../../../Pictures/assets/06-JVM原理/7594235f8b2635a7d27993652c071a28.png)
...
![image-20200710081627217](../../../../../../../Pictures/assets/06-JVM原理/f86ee0f0440d4bcdad5a1fb085865371.png)
...
![image-20200710082141643](../../../../../../../Pictures/assets/06-JVM原理/f1126c7cba0146acb61dd8dff6abaa78.png)

Java代码编译是由Java源码编译器来完成，流程图如下所示：

![image-20200710082433146](../../../../../../../Pictures/assets/06-JVM原理/92b5a6060f99488dba4bc808f8a8ff40.png)

我们用一个总的图，来说说 解释器和编译器

![image-20200710083656277](../../../../../../../Pictures/assets/06-JVM原理/9333d30cca8d406d8de852d71649a799.png)
...
![image-20200710085323733](../../../../../../../Pictures/assets/06-JVM原理/3e3f000effa64516af99787fc51fe54c.png)
...
![image-20200710085553258](../../../../../../../Pictures/assets/06-JVM原理/950838a3001145998f302adfc41d86ac.png)
...
![image-20200710090203674](../../../../../../../Pictures/assets/06-JVM原理/a251358235fe451a9b9a65468edad5a0.png)
...
![image-20200710095417462](../../../../../../../Pictures/assets/06-JVM原理/70be5f7496364b5287ac95da637b52cf.png)
...
![image-20200710101829934](../../../../../../../Pictures/assets/06-JVM原理/f2bc818486494d27b1c43ce563352d32.png)
...
![image-20200710103103869](../../../../../../../Pictures/assets/06-JVM原理/75cd832446b64b50933daef8912f8f4f.png)
...
![image-20200710103340273](../../../../../../../Pictures/assets/06-JVM原理/df8bf85ff0f7446bb863f7560c549291.png)
...
![image-20220518110001063](../../../../../../../Pictures/assets/06-JVM原理/image-20220518110001063.png)
...
![image-20200711093546398](../../../../../../../Pictures/assets/06-JVM原理/97ac3bf8c4e94d1099b01c4b79b74b33.png)

![image-20200711093558709](../../../../../../../Pictures/assets/06-JVM原理/9c8c780ac414468f86be921ccc174e38.png)
...
![image-20200711102231129](../../../assets/06-JVM%E5%8E%9F%E7%90%86/2abb90c72259493a806e9a3488d01c82.png)
...
![image-20200712084539884](../../../assets/06-JVM%E5%8E%9F%E7%90%86/dd14a16901be4a899a77cd0f192b79d5.png)

##### 什么是垃圾

在提到什么是垃圾之前，我们先看下面一张图

![image-20200712085456113](../../../assets/06-JVM%E5%8E%9F%E7%90%86/68e565eb5a4d4f618e3f62a8bd4191f5.png)
...
![image-20200712090848669](../../../assets/06-JVM%E5%8E%9F%E7%90%86/d8dd412e4568448180aeca6b8c0c95cf.png)
...
<img src="../../../assets/06-JVM%E5%8E%9F%E7%90%86/cf724529d4c04f9ea4064dc6c088ea8b.png" alt="image-20200712092427246"  />
...
![image-20200712102205795](../../../assets/06-JVM%E5%8E%9F%E7%90%86/d9be5130f1094f3a8591e924c050c253.png)
...
![image-20200712103230349](../../../assets/06-JVM%E5%8E%9F%E7%90%86/19ff61c8b6e94ac788adcbf2b6a29229.png)
...
![image-20200712104149246](../../../assets/06-JVM%E5%8E%9F%E7%90%86/6b260e7b92b1416da0ec37014dc7f7e3.png)
...
![image-20200712104622677](../../../assets/06-JVM%E5%8E%9F%E7%90%86/a75b0c204d2043939823e0c93a3f0c84.png)
...
![image-20200712110411885](../../../assets/06-JVM%E5%8E%9F%E7%90%86/d828a8387ad9443bab6b6274f835806a.png)
...
![image-20220520110810924](../../../assets/06-JVM%E5%8E%9F%E7%90%86/image-20220520110810924.png)
...
![image-20200712112026317](../../../assets/06-JVM%E5%8E%9F%E7%90%86/acb49ce72eed4f9fad85a9a1e0816bdd.png)
...
![image-20220520112014175](../../../assets/06-JVM%E5%8E%9F%E7%90%86/image-20220520112014175.png)

* 方式三：使用MAT打开Dump文件

打开后，我们就可以看到有哪些可以作为GC Roots的对象

![image-20220520112230638](../../../assets/06-JVM%E5%8E%9F%E7%90%86/image-20220520112230638.png)
...
![image-20220520113841363](../../../assets/06-JVM%E5%8E%9F%E7%90%86/image-20220520113841363.png)
...
![image-20220520114607231](../../../assets/06-JVM%E5%8E%9F%E7%90%86/image-20220520114607231.png)

然后我们通过线程，还能够定位到哪里出现OOM

![image-20220520114730162](../../../assets/06-JVM%E5%8E%9F%E7%90%86/image-20220520114730162.png)
...
![image-20200712150935078](../../../assets/06-JVM%E5%8E%9F%E7%90%86/dfda028dbb924ed58cb0b1a95637da1b.png)
...
![image-20200712151916991](../../../assets/06-JVM%E5%8E%9F%E7%90%86/5585bb2b64eb4528970e244b46835d6a.png)

把可达的对象，直接复制到另外一个区域中复制完成后，A区就没有用了，里面的对象可以直接清除掉，其实里面的新生代里面就用到了复制算法。

![image-20200712152029615](../../../assets/06-JVM%E5%8E%9F%E7%90%86/0533a6c4af2c4a2da59fdecb54623780.png)
...
![image-20200712152847218](../../../assets/06-JVM%E5%8E%9F%E7%90%86/33caf928236744f489912ab7306ae1f8.png)
...
![image-20200712153236508](../../../assets/06-JVM%E5%8E%9F%E7%90%86/7586a82ca34a4d7ca59cd1b262c663be.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/4bf277baeebecf3149932efcd0b633e1.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/bb799f01dbb97977a9982f3aec357c2b.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/da330f57511e001912a8b54ec318aebe.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/c14377f8f63a8a5f6065e5e5d64f06bc.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/eadd4c52a22ff214a66ceeb63707d765.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/b4d5bd5866612e10b455d754fb01b43d.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/6f81ae7cf6e3a152850aaf7dc940165a.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/60110a22fef4effd410f7f4af0ea5900.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/959f1cb1978461d71193eef4d74feadc.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/abce4476defcba4f3c2c88287552ff16.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/be720c41daae2e1ded86507926c8a2f7.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/6d15166d74f8a9659eb9c9f3f7294a38.png)
...
![image-20200713085306400](../../../assets/06-JVM%E5%8E%9F%E7%90%86/b18aee33c11d4977a93a3dfe37ef6cf4)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/e38e97596a26d465d8833641d0de0329.png)

官方手册：https://www.oracle.com/technetwork/java/javase/tech/memorymanagement-whitepaper-1-150020.pdf

###### 7款经典收集器与垃圾分代之间的关系

![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/7dfc06877b908e87c0b6f2600c684665.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/be60a5221009a3829f8561636bfe8ce8.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/dc391193168f023d66f7a4ee56527494.png)
...
![Untitled](../../../assets/06-JVM%E5%8E%9F%E7%90%86/6e02bd6005c8a8d666d6e94864cd2bbc.png)
