...
![image-20220226130540744](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806492.png)
...
用带空心菱形的实线表示<img src="https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806493.png" alt="image-20220226131223355" style="zoom: 50%;" /> ，菱形指向整体，箭头指向个体。

**组合（Combination）**：整体与部分的关系，组合比聚合更加严格，当某个实体组合成 另一个实体时，二者具有相同的生命周期，例如手臂和人之间存在的是组合关系。 用带实心菱形的实线表示 <img src="https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806494.png" alt="image-20220226131315234" style="zoom: 50%;" />，菱形指向整体，箭头指向个体。

**泛华（Generalization）**：表示一个更泛化的元素和一个更具体的元素之间的关系，与继 承是同一个概念。用带三角箭头的实线表示 ，箭头指向父类。

**实现（Realization**）：类与接口的关系，类实现接口。 用带三角箭头的虚线表示<img src="https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806495.png" alt="image-20220226135152000" style="zoom:33%;" /> ，箭头指向父接口。 

**依赖（Dependency）**：如果一个类的改动会影响到另一个类，则两个类之间存在依赖 关系，一般而言，依赖是单向的。 用带普通箭头的虚线表示<img src="https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806496.png" alt="image-20220226135122090" style="zoom: 33%;" /> ，箭头指向被依赖者。
...
![image-20220226135317892](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806497.png)

类与类之间的关系主要有六种：关联、聚合、组合、继承、实现和依赖，这六种关系 的箭头表示如下：

![image-20220226135334794](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806498.png)
...
![image-20220226135620032](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806499.png)

##### 实现关系

接口（包括抽象类）是方法的集合，在实现关系中，类实现了接口，类中的方法实现 了接口声明的所有方法。例如：汽车和轮船都是交通工具，而交通工具只是一个可移动 工具的抽象概念，船和车实现了具体移动的功能。

![image-20220226135638548](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806500.png)

##### 组合关系

组合关系表示类之间整体与部分的关系，整体和部分有一致的生存期。一旦整体对象 不存在，部分对象也将不存在，是同生共死的关系。例如：人由头部和身体组成，两者 不可分割，共同存在。

![image-20220226135659279](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806501.png)

##### 聚合关系

聚合关系也表示类之间整体与部分的关系，成员对象是整体对象的一部分，但是成员 对象可以脱离整体对象独立存在。例如：公交车司机和工衣、工帽是整体与部分的关系， 但是可以分开，工衣、工帽可以穿在别的司机身上，公交司机也可以穿别的工衣、工帽。

![image-20220226135710114](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806502.png)
...
![image-20220226135735974](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806503.png)
...
![image-20220226135749765](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806504.png)

这六种类关系中，组合、聚合和关联的代码结构一样，可以从关系的强弱来理解，各 类关系从强到弱依次是：继承→实现→组合→聚合→关联→依赖。

UML 类图是面向对象设计的辅助工具，但并非是必须工具，所以我们把它作为架构 师软技能来讲解。

![image-20220226135805439](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806505.png)

##### 案例分析

![image-20220226143227242](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806506.png)
...
![image-20220226144651644](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806507.png)

###### 选项（Opt）

包含一个可能发生或不发生的序列；

![image-20220226144709243](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806508.png)

###### 循环（Loop）

片段重复一定次数，可以在临界中指示片段重复的条件。

![image-20220226144736917](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806509.png)

###### 并行（Par）

![image-20220226144801873](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806510.png)
...
![image-20220226144902283](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221806511.png)
...
![image-20220227153645318](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731060.png)

![image-20220227153815630](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731061.png)
...
![image-20220227162757772](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731062.png)
...
![image-20220427204819259](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204282337905.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731063.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731064.png)
...
![img](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731065.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204221731066.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040881.png)
...
![image-20220423114910077](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040883.png)

然后直接输入对应的数字`4`

![image-20220423115018078](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040884.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040885.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040886.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040887.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040888.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040889.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040890.png)
...
![](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040891.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040892.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040893.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040894.png)

类图如下：

![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040895.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040896.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040897.png)

类图如下：

![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040898.png)
...
**外观模式**：又被称为**门面模式**，是一种通过为多个复杂的子系统提供一个一致的接口，而使这些子系统更加容易被访问的模式。**该模式对外有一个统一接口，外部应用程序不用关心内部子系统的具体的细节，这样会大大降低应用程序的复杂度，提高了程序的可维护性。**
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040899.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251040900.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251236622.png)

**RequestFacade类就使用了外观模式。先看结构图：**

![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204251236624.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209191.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209193.png)

比如作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择Idea进行开发，也可以使用eclipse进行开发，也可以使用其他的一些开发工具。

![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209194.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209195.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209196.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209197.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204271209198.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204282337907.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204282337908.png)
...
- **状态模式关键是各个状态子类必须知道下一个状态是啥，且要把逻辑判断转移到各个状态子类中**， 客户端不需要了解状态迁移的顺序，且状态模式虽然类图和策略模式几乎一样， 但是**策略目的是针对单一算法的运行时替换，客户端需要事先了解策略，主动去选择合适的策略， 不存在状态的自动迁移！**
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204301511413.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204301511415.png)
...
![image-20220430144406775](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204301511416.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202205011445342.png)
...
备忘录角色对发起人对象提供一个宽接口，而为其他对象提供一个窄接口。在Java语言中，实现双重接口的办法就是将**备忘录类**设计成**发起人类**的**内部成员类**。
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202205011445344.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202205011445345.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202205011445346.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204282337909.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204282337910.png)
...
![在这里插入图片描述](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202204282337911.png)
...
**委派模式：**委派模式又称为委托模式，它的基本作用就是负责任务的调度和任务分配，将任务的分配和执行分离开来。可以看做是一种特殊情况下的静态代理的全权代理。（不属于GOF，需要和策略模式配合使用，记住JVM中的双亲委派机制）。

比如，老板将任务委托给员工，员工只需要将任务的结果报告给老板即可。

![image-20220508150944053](https://raw.githubusercontent.com/TheFoxFairy/ImgStg/main/202205081548590.png)
