...
![RabbitMQ-00000004](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000004.png)
...
优点：**单机吞吐量十万级**，可用性非常高，分布式架构，**消息可以做到 0 丢失**,MQ 功能较为完善，还是分布式的，扩展性好，支**持10亿级别的消息堆积**，不会因为堆积导致性能下降，源码是java我们可以自己阅读源码，定制自己公司的 MQ。
...
天生为**金融互联网**领域而生，对于可靠性要求很高的场景，尤其是电商里面的订单扣款，以及业务削峰，在大量交易涌入时，后端可能无法及时处理的情况。RoketMQ 在稳定性上可能更值得信赖，这些业务 场景在阿里双11已经经历了多次考验，如果你的业务有上述并发场景，建议可以选择 RocketMQ。
...
![image-20210625230930992](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20210625230930992.png)
...
![RabbitMQ-00000007](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000007.png)
...
- **Channel**：如果每一次访问 RabbitMQ 都建立一个 Connection，在消息量大的时候建立TCP Connection的开销将是巨大的，效率也较低。Channel 是在 connection 内部建立的逻辑连接，如果应用程序支持多线程，通常每个thread 创建单独的 channel 进行通讯，AMQP method 包含了 channel id 帮助客 户端和 message broker 识别 channel，所以 channel 之间是完全隔离的。**Channel 作为轻量级的 Connection 极大减少了操作系统建立 TCP connection 的开销**。
...
RabbitMQ 中的交换器、交换器类型、队列、绑定、路由键等都是遵循的AMQP协议中相 应的概念。目前RabbitMQ 最新版本默认支持的是AMQP 0-9-1。
...
![image-20220414221848167](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220414221848167.png)
...
![image-20220414222839776](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220414222839776.png)
...
![image-20220414223851935](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220414223851935.png)
...
![image-20220414224443532](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220414224443532.png)
...
![image-20220414232633602](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220414232633602.png)
...
![img](../../../../../../../Pictures/assets/RabbitMQ笔记/89vK3k.jpg)
...
![image-20220415002319742](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220415002319742.png)
...
![image-20220415002328980](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220415002328980.png)

#### 测试

然后开始在Task任务窗口输入数据

![image-20220415002353173](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220415002353173.png)

然后观察Worker的窗口，发现两个工作队列在轮训接收队列的消息。

![image-20220415002431949](../../../../../../../Pictures/assets/RabbitMQ笔记/image-20220415002431949.png)
...
![RabbitMQ-00000017](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000017.png)

- true 代表批量应答 channel 上未应答的消息：比如说 channel 上有传送 tag 的消息 5,6,7,8 当前 tag 是8 那么此时5-8 的这些还未应答的消息都会被确认收到消息应答
- false 同上面相比只会应答 tag=8 的消息 5,6,7 这三个消息依然不会被确认收到消息应答

![RabbitMQ-00000018](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000018.png)
...
![RabbitMQ-00000019](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000019.png)
...
![RabbitMQ-00000021](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000021.png)

在生产者发出消息后，可以在web界面看到当前正在排队处理的任务，因为C2处理任务慢，任务正在排队处理中。

![RabbitMQ-00000023](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000023.png)

在发送者发送消息 dd，发出消息之后的把 C2 消费者停掉，按理说该 C2 来处理该消息，但是由于它处理时间较长，在还未处理完，也就是说 C2 还没有执行 ack 代码的时候，C2 被停掉了， 此时会看到消息被 C1 接收到了，说明消息 dd 被重新入队，然后分配给能处理消息的 C1 处理了。



![RabbitMQ-00000024](../../../../../../../Pictures/assets/RabbitMQ笔记/RabbitMQ-00000024.png)
